...
const Tag = () => {
  ...
  const IconFont = ANTD_ICONS.createFromIconfontCN({
    scriptUrl: [
      '//at.alicdn.com/t/c/font_3879864_6yy409x8jso.js'
    ],
  });

  return (
    <div className='content-layout'>
      <Tabs defaultActiveKey="all" destroyInactiveTabPane={true}>
